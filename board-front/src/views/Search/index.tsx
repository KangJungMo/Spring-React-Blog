...
export default function Search() {
  ...
  //      state: 관련 검색어 리스트 상태    //
  const [relativeWordList, setRelationWordList] = useState<string[]>(['관련', '검색어']);
  ...
  //      function: get search word list response 처리 함수   //
  ...
  //      function: get relation word list response 처리 함수   //
    ...
    <div id='search-wrapper'>
      <div className='search-container'>
        ...
        <div className='search-contents-box'>
          ...
          <div className='search-contents'>{viewList.map(boardListItem => <BoardItem boardListItem={boardListItem} />)}
          </div>
          }
