...
export default function Header() {
  ...
  const UploadButton =() => {
    ...
    //    state: 게시물 상태    //
    const {title, content, boardImageFileList, resetBoard} = useBoardStroe();
  ...
  //      function: 로그인 유저가 변경될 때마다 실행될 함수
  useEffect(() => {
    ...
    <div id='header'>
      <div className='header-container'>
        <div className='header-left-box' onClick={onLogoClickHandler}>
          ...
          <div className='header-logo'>{'Kangs Board'}</div>
        </div>
        <div className='header-right-box'>
          {(isAuthPage || isMainPage || isSearchPage || isBoardDetailPage) && <SearchButton/>}
          {(isMainPage || isSearchPage || isBoardDetailPage || isUserPage) && <MyPangeButton/>}
