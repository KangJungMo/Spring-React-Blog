        ...
        <div className='footer-container'>
            <div className='footer-top'>
                ...
                <div className='footer-link-box'>
                    <div className='footer-email-link'>{'jungmo5416@naver.com'}</div>
            ...
            <div className='footer-bottom'>
                <div className='footer-copyright'>{'Copyright @ 2023 Kang. All Rights Reserved.'}</div>
            </div>
        </div>
    </div>
  )
